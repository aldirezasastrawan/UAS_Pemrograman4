package com.aldirezasastrawan.mahasiswaonline;
...
/**
 * Created by Aldi Reza Sastrawan on 6/18/2016.
 */
public class UpdateDeleteActivity extends ActionBarActivity {

    JSONParser jParser = new JSONParser();
    String url_update_mhs= "http://aldirezasastrawan.web.id/android/update_mhs.php";
    String url_delete_mhs= "http://aldirezasastrawan.web.id/android/delete_mhs.php";
